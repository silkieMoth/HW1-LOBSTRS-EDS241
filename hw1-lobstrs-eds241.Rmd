...
ggplot(aes(x = year, y = log(counts), fill = factor(treat))) + 
    ...
    ggborderline::geom_borderline(aes(x = year, y = reg, color = factor(treat), bordercolour = 'black'), lwd = 1) + 
